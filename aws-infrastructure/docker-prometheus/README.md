...
```
docker tag prometheus-custom 7605-0831-7047.dkr.ecr.eu-central-1.amazonaws.com/monitoring:prometheus
```

```
docker push 7605-0831-7047.dkr.ecr.eu-central-1.amazonaws.com/monitoring:prometheus
```